...
export const resources = {
  'pt-BR': { common: ptCommon, auth: ptAuth, account: ptAccount, admin: ptAdmin, errors: ptErrors },
  'en-US': { common: enCommon, auth: enAuth, account: enAccount, admin: enAdmin, errors: enErrors },
  'es-ES': { common: esCommon, auth: esAuth, account: esAccount, admin: esAdmin, errors: esErrors },
} as const;
